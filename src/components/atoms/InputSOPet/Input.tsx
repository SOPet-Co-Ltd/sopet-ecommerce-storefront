...
export function Input({
  ...
  const variantClasses = {
    ...
    bordered: "bg-sop-neutral-gray-600 border border-solid border-sop-neutral-grayalpha-100",
    underlined: "bg-transparent border-b border-solid border-sop-neutral-grayalpha-100 rounded-none",
  } as const
  ...
  return (
    <div className="w-full">
      {title !== undefined && (
        <label htmlFor={finalId} className="sop-body-xs-medium text-sop-neutral-gray-300 flex items-center gap-1 mb-2">
          {title}
