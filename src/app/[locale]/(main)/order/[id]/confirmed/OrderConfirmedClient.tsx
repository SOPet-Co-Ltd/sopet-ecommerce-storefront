  ...
  return (
    <div className="py-24 flex flex-col items-center justify-center text-center px-4">
      ...
      <Text className="text-gray-500 max-w-md">
        ...
        กรุณาลองตรวจสอบที่หน้า &quot;การสั่งซื้อของฉัน&quot; ในบัญชีของคุณ
      </Text>
      <Link
        href="/user/orders"
...
export const OrderConfirmedClient = ({
  orderId,
  ...
  return (
    <main className="container bg-gray-50/50 min-h-screen pb-20">
      ...
      <div className="pt-12 pb-6 px-4 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out flex flex-col items-center">
        ...
        <Heading
          level="h1"
          className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4 tracking-tight"
        >
          การสั่งซื้อสำเร็จ! 🎉
        </Heading>

        <Text className="text-gray-600 text-center max-w-lg mb-2 text-lg">
          ขอบคุณที่ไว้วางใจ Sopet
          เราได้ส่งรายละเอียดการสั่งซื้อไปที่อีเมลของคุณแล้ว
        </Text>
